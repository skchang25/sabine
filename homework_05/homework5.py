...
#     1. Git is a software that is able to track and save changes made to you code to an remote repository, while Github is a platform for storing and sharing codd through repositories created by indivisuals.
